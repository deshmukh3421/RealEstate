...
useEffect(()=>{
  ...
  return (
    <div className='absolute top-0 left-0 w-full z-10'>
      ...
      {/*--------mobile-menu------------*/}
      <div onClick={()=> setShowMobileMenu(false)} className={`md:hidden ${showMobileMenu ? 'fixed w-full' : 'h-0 w-0'} right-0 bottom-0 top-0 overflow-hidden bg-white transition-all`}>
